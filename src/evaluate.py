...
def evaluate_cost(list_x, list_c , tonality, meter=4, first_on_beat=0, mode="L") : 
    ...
    mode : string, optional
        The default is "L" : return will be a list of sum-of-cost for each hard/sodt constraints
        if given everything else than"L": return will be one number,sum of all costs for all constraints
    Returns
    list or number
